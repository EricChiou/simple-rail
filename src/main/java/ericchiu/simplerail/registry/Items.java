...
public class Items {
	...
	public static final RegistryObject<Item> Y_CROSS_RAIL = REGISTER.register(I18n.BLOCK_Y_CROSS_RAIL,
			() -> new BlockItem(Blocks.Y_CROSS_RAIL.get(), new Item.Properties().tab(Rail.TAB)));
	public static final RegistryObject<Item> Y_CROSS_RIGHT_RAIL = REGISTER.register(I18n.BLOCK_Y_CROSS_RIGHT_RAIL,
			() -> new BlockItem(Blocks.Y_CROSS_RIGHT_RAIL.get(), new Item.Properties().tab(Rail.TAB)));
	// machine
